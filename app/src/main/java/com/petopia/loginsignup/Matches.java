...
public class Matches {
    ...
    public Matches(int acceptedUserId, String acceptedFirstName, String acceptedLastName, int acceptingUserId, String acceptingFirstName, String acceptingLastName, String acceptingPetName, String acceptingPetID, String acceptedPetName, String acceptedPetID, boolean isAccepted) {
