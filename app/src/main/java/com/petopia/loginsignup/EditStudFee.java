...
public class EditStudFee extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_stud_fee);
                    ...
                    if (responseCode == HttpURLConnection.HTTP_OK) {
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                Toast.makeText(EditStudFee.this, "Shares updated successfully", Toast.LENGTH_SHORT).show();
                                finish();
                            }
                        });
                    } else {
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(EditStudFee.this, "Error updating shares", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
