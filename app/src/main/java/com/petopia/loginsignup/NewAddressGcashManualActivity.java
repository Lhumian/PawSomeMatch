...
public class NewAddressGcashManualActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                StringRequest request = new StringRequest(Request.Method.POST, url,
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                ...
                                Toast.makeText(NewAddressGcashManualActivity.this, response, Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(NewAddressGcashManualActivity.this, AddressGcashManualActivity.class);
                ...
                Volley.newRequestQueue(NewAddressGcashManualActivity.this).add(request);
