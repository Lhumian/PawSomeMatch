        ...
        StringRequest request = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(AddressActivity.this, "Error retrieving addresses", Toast.LENGTH_SHORT).show();
                    }
                }) {
            @Override
...
// Add the request to the Volley request queue
    ...
    private void processResponse(String response) {
        try {
            ...
            // Check if the addressList is empty and show the message accordingly
            if (addressList.isEmpty()) {
                findViewById(R.id.noAddressMessage).setVisibility(View.VISIBLE);
            } else {
                findViewById(R.id.noAddressMessage).setVisibility(View.GONE);
            }
