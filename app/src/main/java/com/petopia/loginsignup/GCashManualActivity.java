...
public class GCashManualActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAddress.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(GCashManualActivity.this, AddressGcashManualActivity.class);
        ...
        btnCheckout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedName1.isEmpty()) {
                    ...
                    Toast.makeText(GCashManualActivity.this, "Please select an address before checkout", Toast.LENGTH_SHORT).show();
                ...
                String paymentMode = "GCash Manual";
                ...
                /*editor.putDouble("shippingPrice", shippingPrice);*/
                ...
                Intent intent = new Intent(GCashManualActivity.this, GcashPaymentActivity.class);
                startActivity(intent);
