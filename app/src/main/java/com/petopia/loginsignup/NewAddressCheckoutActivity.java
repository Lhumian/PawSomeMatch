...
public class NewAddressCheckoutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                StringRequest request = new StringRequest(Request.Method.POST, url,
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                ...
                                Toast.makeText(NewAddressCheckoutActivity.this, response, Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(NewAddressCheckoutActivity.this, AddressCheckoutActivity.class);
                ...
                Volley.newRequestQueue(NewAddressCheckoutActivity.this).add(request);
