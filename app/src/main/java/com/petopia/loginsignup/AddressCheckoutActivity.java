    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addAddress.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AddressCheckoutActivity.this, NewAddressCheckoutActivity.class);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(AddressCheckoutActivity.this, CheckoutActivity.class);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(AddressCheckoutActivity.this, "Error retrieving addresses", Toast.LENGTH_SHORT).show();
                    }
                }) {
            @Override
