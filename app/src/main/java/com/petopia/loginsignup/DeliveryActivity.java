        ...
        btnCheckout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedName1.isEmpty()) {
                    ...
                    Toast.makeText(DeliveryActivity.this, "Please select an address before checkout", Toast.LENGTH_SHORT).show();
                    return; // Stop the checkout process if the address is not selected
                }
                // Obtain the necessary data for the order
                ...
                String deliveryProgress = "On Progress"; // Initial status
                ...
                client.newCall(request).enqueue(new Callback() {
                    ...
                    public void onFailure(Call call, IOException e) {
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(DeliveryActivity.this, "Failed to connect to the server", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                        ...
                        if (response.isSuccessful()) {
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    if (responseBody.contains("successfully")) {
                                        ...
                                        // Insertion failed
                                        Toast.makeText(DeliveryActivity.this, "Failed to create the order: " + responseBody, Toast.LENGTH_SHORT).show();
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    Toast.makeText(DeliveryActivity.this, "Server returned an error", Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                    }
